...
import versioneer
versioneer.VCS = 'git'
versioneer.versionfile_source = 'lib/tpn/_version.py'
versioneer.versionfile_build = 'tpn/_version.py'
versioneer.tag_prefix = 'v'
versioneer.parentdir_prefix = 'tpn-'
...
def version_pre_versioneer():
    return (
        re.compile(r"^__version__ = '(.*?)'$", re.S)
          .match(read('lib', 'tpn', '__init__.py'))
          .group(1)
    )
